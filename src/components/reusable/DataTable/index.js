...
import DataLoadSpinner from "../Spinner/DataLoadSpinner";
...
function Table({columns, data = [], loading, addButton}) {
    ...
    <>
                        ...
                        return (
                          ...
                          >
                            {cell.column.Cell.name === "defaultRenderer"
                              ? <div
                                className="text-sm text-gray-500">{cell.render('Cell')}</div>
                              : cell.render('Cell')
                            }
                          </td>
                        )
      ...
      <div className="py-3 flex items-center justify-between">
        <div className="flex-1 flex justify-between sm:hidden">
          <PrimaryButton onClick={() => previousPage()} disabled={!canPreviousPage}
                         text={"Previous"}/>
          <PrimaryButton onClick={() => nextPage()} disabled={!canNextPage} text={"Next"}/>
        </div>
